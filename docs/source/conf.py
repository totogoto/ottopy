...
# -*- coding: utf-8 -*-
#
# ottopy documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ottopy', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ottopy.tex', 'ottopy Documentation',
